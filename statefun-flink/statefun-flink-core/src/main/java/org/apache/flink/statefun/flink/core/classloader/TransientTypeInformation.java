 ...
 */
public class TransientTypeInformation<T> extends TypeInformation<T> {

  private static final long serialVersionUID = 1L;

  private final transient TypeInformation<T> inner;

  public TransientTypeInformation(TypeInformation<T> inner) {
  ...
  public String toString() {
    return "DispatcherTypeInfo(" + getInner().toString() + ")";
  }
  ...
  public boolean equals(Object o) {
    ...
    if (getClass() != o.getClass()) {
      ...
      TransientTypeInformation<?> that = (TransientTypeInformation<?>) o;
