 ...
 * org.apache.flink.statefun.sdk.StatefulFunction}.
 *
 * <p>{@see FunctionTestHarness} for usage details.
 */
public final class StatefunMatchers {

  private StatefunMatchers() {
  ...
  /** A matcher that checks the function did not send any matchers. */
  public static NoResponseMatcher noResponse() {
    return new NoResponseMatcher();
  }
}
